    ...
    <div>
        ...
        <table style="background-color: #c0c0c0; width: 100%;">
            ...
            <perl>
                ...
                my $bookmarks_neuron    = $cur_user->getBookmarksNeuron();
                my $bookmarks           = [];
                if ($bookmarks_neuron){
                    $bookmarks = $bookmarks_neuron->getNeighs();
                }
                my $i       = 0;
                my $style   = '';
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <perl>
                            ...
                            my @types = sort (keys %$neurons_info);
                            foreach my $neuron_type (@types){
                                $ret .= "<option value=\"$neuron_type\">$neuron_type</option>\n";
                            }
                            return $ret;
                        </perl>
                        </select>
