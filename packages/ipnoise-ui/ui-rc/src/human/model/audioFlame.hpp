...
#define MODEL_AUDIO_FLAME_NEURON_NAME       "model_audio_flame_002"
#define MODEL_AUDIO_FLAME_HZ_PER_NEURON     50
#define MODEL_AUDIO_FLAME_UP_HZ             4000
#define MODEL_AUDIO_FLAME_ROWS_COUNT        10

typedef map<string, NeuronSptr>     AudioFlameNeurons;
typedef AudioFlameNeurons::iterator AudioFlameNeuronsIt;
