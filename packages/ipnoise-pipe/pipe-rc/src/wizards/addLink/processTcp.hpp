#ifndef WIDGET_ADD_LINK_PAGE_TCP_HPP
#define WIDGET_ADD_LINK_PAGE_TCP_HPP
...
class WizardAddLinkPageProcessTcp
    :   public QWizardPage
{
    Q_OBJECT

    public:
        WizardAddLinkPageProcessTcp(
            Api                 *a_api,
            ContactListPath     &a_contact_path,
            QWidget             *a_parent = 0
        );
        virtual ~WizardAddLinkPageProcessTcp();
