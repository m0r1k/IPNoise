...
#include "clientHandlerTelnetCommandGetContactList.h"

ClientHandlerTelnetCommandGetContactList::ClientHandlerTelnetCommandGetContactList(
...
const char *ClientHandlerTelnetCommandGetContactList::getName()
{
    return "api_getContactList";
};

int ClientHandlerTelnetCommandGetContactList::run(
    int argc, char* const* argv)
{
    PDEBUG(5, "getcontactlist command received\n");
    ...
    res = do_init(argv[0],
        ...
        "    <commands>\n"
        "       <command type=\"getContactList\" ver=\"0.01\"/>\n"
        "    </commands>\n"
        "</ipnoise>\n"
    );
    if (res){
